...
2. Go to Administer > Site building > Modules and enable the Devel Demo
module.
...
There is nothing to configure. Go to <yoursite>/devel_demo to access the
demos.
...
$Id: README.txt,v 1.1.2.2 2011/02/06 11:08:49 wulff Exp $